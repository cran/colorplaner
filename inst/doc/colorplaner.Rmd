...
Mapping data variables to these U and V components turns this color plane into a 
scale that produces a unique color for each combination of values for the two 
variables, and using these colors for the `color` or `fill` aesthetics of 
plotted objects allows the view to easily approximate the values of
